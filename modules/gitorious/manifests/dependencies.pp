class gitorious::dependencies {
  ...
  case $operatingsystem {
    CentOS: { $package_list = ["monit", "memcached", "ImageMagick","gcc-c++","zlib-devel","make","wget","libxml2","libxml2-devel","libxslt","libxslt-devel","gcc", "ruby-devel", "openssl", "postgresql-devel.x86_64", "postfix", "libicu-devel", "patch"]}
  }
