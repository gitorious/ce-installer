start_containers() {
  ...
  docker run -d --name gitorious-sshd --link gitorious-web:web -p 5022:22 --volumes-from gitorious-data -v /var/log/gitorious/app:/srv/gitorious/app/log gitorious/sshd >/dev/null
